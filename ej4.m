...
Wx_num(1) = (-3*Crank(1,tFin)+4*Crank(2,tFin)-Crank(3,tFin))*50
Wx_num(M(1/100)+1) = (-Crank(M(1/100)-1,tFin)+4*Crank(M(1/100),tFin)-3*Crank(M(1/100)+1,tFin))*-50;

for i = 2:M(1/100)
   Wx_num(i) = (Crank(i+1,tFin)-Crank(i-1,tFin))*50;
end
